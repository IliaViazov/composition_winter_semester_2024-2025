...
The beautiful part of it, that all of this is written in markdown format (.md). You can export/convert in this format in very easy way almost every text editor, for example Notes on Macbook with this [utility](https://apps.apple.com/de/app/exporter/id1099120373?l=en-GB&mt=12), or Pages, and I believe — KeyNote. Or also just write in Markdown format directly with some kind of a text editor like Visual Studio Code, or directly on the Github, because there is a preview of what you are writing.
<br>
